    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            for ($i = 0; $i < count($cloths_index); $i++) {
                ...
                if ($recodes['men_women_kid'] == 1) {
                    $cloth = "./images/cloths/men/$cloths_index[$i].0.jpg";
                } else if ($recodes['men_women_kid'] == 2) {
                    $cloth = "./images/cloths/women/$cloths_index[$i].0.jpg";
                } else if ($recodes['men_women_kid'] == 3) {
                    $cloth = "./images/cloths/kid/$cloths_index[$i].0.jpg";
                }
                $id=$cloths_index[$i];
                $catagery = "cloths";
            ...
            ?>
                <div class="col-4">
                    <a id='url' href="<?php echo $url;?>">
                        <div>
                            <center><img src=<?php echo $cloth ?> alt="cloth" style="width:300px;height:200px"></center>
                        </div>
                    </a>
                    <div>
        ...
        <div class="row">
            ...
            for ($i = 0; $i < count($shoes_index); $i++) {
                ...
                $recodes = mysqli_fetch_assoc($select);
                if ($recodes['men_women_kid'] == 1) {
                    $shoe = "./images/shoes/men/$shoes_index[$i].0.jpg";
                } else if ($recodes['men_women_kid'] == 2) {
                    $shoe = "./images/shoes/women/$shoes_index[$i].0.jpg";
                } else if ($recodes['men_women_kid'] == 3) {
                    $shoe = "./images/shoes/kid/$shoes_index[$i].0.jpg";
                }
                $id=$shoes_index[$i];
                $catagery = "shoes";
                $url="item_page1.php?id={$id} & catagery={$catagery}";
        ...
        <img src="./images/bags.png" style="width:100%;">
        <h3>
        ...
        <div class="row">
            ...
            for ($i = 0; $i < count($bags_index); $i++) {
                ...
                $select = mysqli_query($connection, $query);
                $recodes = mysqli_fetch_assoc($select);
                $bag = "./images/bags/$bags_index[$i].0.jpg";
            ...
            ?>
                <div class="col-4">
                    <a id='url' href="<?php echo $url;?>">
                        <div>
                            <center><img src=<?php echo $shoe ?> alt="bag" style="width:300px;height:200px"></center>
                        </div>
                    </a>
                    <div>
                        <center><?php echo $recodes['name']; ?></center>
        ...
        <img src="./images/toys.png" style="width:100%;">
        <h3>
        ...
        <div class="row">
            ...
            for ($i = 0; $i < count($toys_index); $i++) {
                ...
                $select = mysqli_query($connection, $query);
                $recodes = mysqli_fetch_assoc($select);
                $toy = "./images/toys/$toys_index[$i].0.jpg";
            ...
            ?>
                <div class="col-4">
                    <a id='url' href="<?php echo $url;?>">
                        <div>
                            <center><img src=<?php echo $shoe ?> alt="toy" style="width:300px;height:200px"></center>
                        </div>
                    </a>
                    <div>
                        <center><?php echo $recodes['name']; ?></center>
