...
<head lang="en">
    ...
    <style>
        ...
        .bg {
            /* The image used */
            background-image: url("https://free4kwallpapers.com/uploads/originals/2015/11/24/in-shoes-wallpaper.jpg");
        ...
        <div>
            ...
            if (isset($_REQUEST['submit'])) {
                ...
                //sending user inputs database
                    ...
                    $client = "INSERT INTO shoes (name,price,size,men_women_kid,discription,total_item) 
            ...
            if (isset($_REQUEST['update'])) {
                ...
                $client = "UPDATE shoes SET name='$name',price='$price',size='$size',men_women_kid='$men_women_kid',discription='$discription',total_item='$total_item' WHERE id=$id"; 
                    mysqli_query($connection, $client); 
            ...
            if (isset($_GET['del'])) {
                $id = $_GET['del'];
                $client = "DELETE FROM shoes WHERE id=$id";
                    mysqli_query($connection, $client);
                header('location: listing.php');
            }
            ?>
            <?php 
                if (isset($_GET['edit'])) {
                    $id = $_GET['edit'];
                    $update = true;
                    $record = mysqli_query($connection, "SELECT * FROM shoes WHERE id=$id");
            ...
            <div class="row">
                <div class="col-8"></div>
                <div class="col-2">
                    <h1 align="center" style="margin-top: 30px; color: white;">
                        Add Shoes
                    </h1>
                </div>
            </div>
