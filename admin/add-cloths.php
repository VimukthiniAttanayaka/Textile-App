...
<head lang="en">
    ...
    <style>
        ...
        .bg {
            /* The image used */
            background-image: url("https://www.wallpapertip.com/wmimgs/70-703412_716132-title-girl-with-the-golden-dress-women.jpg");
    ...
    <div class="container-fluid">
        <div>
            ...
            <div class="row">
                <div class="col-8"></div>
                <div class="col-2">
                    <h1 align="center" style="margin-top: 30px; color: darkblue;">
                        Add Cloths
                    </h1>
                </div>
            </div>
