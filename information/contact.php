    ...
    <div class="content">
      <div class="left-side">
        ...
        <div class="phone details">
          ...
          <div class="text-one">+94 76 1234567</div>
          <div class="text-two">+94 71 9876543</div>
        </div>
        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div>
          <div class="text-one">etextile@gmail.com</div>
          <div class="text-two">info.etextile@gmail.com</div>
        </div>
      </div>
